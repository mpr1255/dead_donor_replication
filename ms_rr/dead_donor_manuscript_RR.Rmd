...
It is unclear how the DDR might apply in case where vital organs are procured from prisoners. China provides no information about whether, and if so how, the prisoner-cum-donor is rendered brain dead in preparation for procurement.
...
The Taiwanese case highlights the challenges inherent in complying with the DDR when procuring hearts and lungs from executed prisoners. According Tsai et al., this only took place with three prisoners in Taiwan before it was stopped.
